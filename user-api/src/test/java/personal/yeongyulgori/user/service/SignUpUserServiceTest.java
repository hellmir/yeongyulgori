...
class SignUpUserServiceTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "홍길동, abcd@abc.com, 1234, 2000-01-01, 01012345678, GENERAL_USER",
            "고길동, abcd@abcd.com, 12345, 2000-02-02, 01012345679, BUSINESS_USER",
            "김길동, abcd@abcde.com, 123456, 2000-03-03, 01012345680, GENERAL_USER"
    })
    void signUpUser(String name, String email, String password,
        ...
        SignUpForm signUpForm = enterUserForm
                (name, email, password, birthDate, phoneNumber, role);
